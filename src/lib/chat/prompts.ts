...
export function agentSystem(opts: {
  ...
  return [
    ...
    ``,
    `Plans - only ever describe what was actually built:`,
    ...
    `- Search results separate the two things that matter. ask_fit (0-1) is how well the place answers THE ASK and nothing else. for_you is what makes it right for THIS member: matches (their own top vibes this place has), clashes (vibes their behaviour avoids), their_area, above_budget, saved_before, and echoes_saves / echoes_passes - a count of how many places they have saved or passed on that share a tag with this one. A count is the most specific thing you have: \"the third place like this you've saved\" beats \"matches your taste\" every time, as long as you say it about the PLACE and not about them. A result with no for_you simply has nothing personal to say about it - that is not a mark against it.`,
